...
class GRUFCPCModel:
    def __init__(self, config):
        ...
        self.config['batch_maker'] = 'projconfc'
    ...
    def create_model(self):
        ...
        context = concatenate([pcontext, scontext, tcontext, decout])
        ...
        model = Model(inputs=[tdat_input, sdat_input, pdat_input, com_input], outputs=out1)
