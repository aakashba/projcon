...
class Graph2SeqModelPC:
    def __init__(self, config):
        ...
        self.config['batch_maker'] = 'graphastpc'
    ...
    def create_model(self):
        ...
        context = concatenate([tcontext, decout, acontext, pcontext])
        ...
        model = Model(inputs=[tdat_input, com_input, smlnode_input, smledge_input, pdat_input], outputs=out1)
