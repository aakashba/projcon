...
class FWAstGRUPCModel:
    def __init__(self, config):
        ...
        self.config['batch_maker'] = 'fw_datsastpc'
    ...
    def create_model(self):
        ...
        context = concatenate([pencout, tencout, seout], axis=1)

        out = Flatten()(context)
        out1 = Dense(self.comvocabsize, activation="softmax")(out)
        
        model = Model(inputs=[tdat_input, pdat_input, sml_input], outputs=out1)
