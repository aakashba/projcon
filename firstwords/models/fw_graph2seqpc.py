...
class FWGraph2SeqModelPC:
    def __init__(self, config):
        ...
        self.config['batch_maker'] = 'fw_graphastpc'
    ...
    def create_model(self):
        ...
        context = concatenate([tencout, astwork, pencout], axis=1)

        out = Flatten()(context)
        out1 = Dense(self.comvocabsize, activation="softmax")(out)
        
        model = Model(inputs=[tdat_input, smlnode_input, smledge_input, pdat_input], outputs=out1)
