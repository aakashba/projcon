...
class FWGraph2SeqModelFC:
    def __init__(self, config):
        ...
        self.config['batch_maker'] = 'fw_graphastfc'
    ...
    def create_model(self):
        ...
        context = concatenate([senc, tencout, astwork], axis=1)

        out = Flatten()(context)
        out1 = Dense(self.comvocabsize, activation="softmax")(out)
        
        model = Model(inputs=[tdat_input, sdat_input, smlnode_input, smledge_input], outputs=out1)
